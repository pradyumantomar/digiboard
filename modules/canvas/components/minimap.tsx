...
const MiniMap = forwardRef<
  HTMLCanvasElement,
  {
    ...
    dragging: boolean;
    setMoveMiniMap: Dispatch<SetStateAction<boolean>>;
  }
>(({ x, y, dragging, setMoveMiniMap }, ref) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        onDragStart={() => setMoveMiniMap((prev) => !prev)}
        onDragEnd={() => setMoveMiniMap((prev: boolean) => !prev)}
